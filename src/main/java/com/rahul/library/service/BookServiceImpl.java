...
import com.rahul.library.repository.AuthorRepository;
import com.rahul.library.repository.BookRepository;
import com.rahul.library.repository.GenreRepository;
...
public class BookServiceImpl implements BookService {
    ...
    public void saveBookForm(BookFormDto bookFormDto) {
        ...
        book.setImageUrl(bookFormDto.getImageUrl());
